...
public class CommonConfig {
    ...
    public static class Specs {
        // Core
        public static final DoubleSpec MAX_FORCE = new DoubleSpec(120.0, 1.0, 100000.0, "Maximum spring force applied to move a grabbed object.");
        public static final DoubleSpec MIN_DISTANCE = new DoubleSpec(2.0, 0.1, 128.0, "Minimum hold distance from the player's eye to the anchor.");
        ...
        public static final DoubleSpec STRENGTH_1_MULTIPLIER = new DoubleSpec(2.0, 1.0, 1000.0);
        public static final DoubleSpec STRENGTH_2_MULTIPLIER = new DoubleSpec(4.0, 1.0, 1000.0);

        // Rotation
        public static final BooleanSpec ENABLE_ROTATION = new BooleanSpec(true);
        public static final DoubleSpec ROTATION_STABILIZATION = new DoubleSpec(0.5, 0.0, 1.0);
        ...
        public static final DoubleSpec ROTATION_MASS_DAMPING_FACTOR = new DoubleSpec(0.02, 0.0, 10.0, "How much object mass slows down rotation.");
        public static final IntSpec ROTATION_TICKS_WINDOW = new IntSpec(5, 1, 200, "Ticks the rotation motor stays active after the last mouse input.");
        ...
        public static final DoubleSpec BAREHANDED_ASSEMBLY_SPEED_MULTIPLIER = new DoubleSpec(1.0, 0.1, 100.0);
        public static final DoubleSpec BAREHANDED_ASSEMBLY_MAX_DISTANCE = new DoubleSpec(2.0, 1.0, 128.0);
        public static final DoubleSpec ASSEMBLY_SERVER_DISTANCE_TOLERANCE = new DoubleSpec(1.0, 0.0, 128.0, "Server-side grace distance added when validating assembly requests.");
        public static final DoubleSpec ASSEMBLY_CLIENT_DISTANCE_TOLERANCE = new DoubleSpec(1.5, 0.0, 128.0, "Client-side grace distance before cancelling the charge.");
        public static final IntSpec FAST_LIFT_ASSEMBLY_TICKS = new IntSpec(2, 1, 1200, "Charge ticks for blocks with a BlockEntity but non-full collision (chests, barrels...).");
        public static final DoubleSpec PULL_THRESHOLD = new DoubleSpec(0.05, 0.0, 10.0);
        public static final DoubleSpec PULL_RESISTANCE_MULTIPLIER = new DoubleSpec(0.6, 0.0, 100.0);
        ...
        // Suspension
        public static final IntSpec STANDING_ON_GRAB_SUSPEND_TICKS = new IntSpec(15, 0, 1200, "Ticks physics stays suspended after stepping off a grabbed object.");
        public static final DoubleSpec GRAB_PROXIMITY_EYE_SUSPEND_DISTANCE = new DoubleSpec(1.0, 0.0, 128.0, "Eye-to-block distance that suspends physics to prevent clipping.");
        public static final DoubleSpec GRAB_PROXIMITY_BODY_SUSPEND_DISTANCE = new DoubleSpec(1.5, 0.0, 128.0, "Foot-to-block distance that suspends physics to prevent clipping.");
        public static final DoubleSpec TENSION_SUSPEND_THRESHOLD = new DoubleSpec(3.5, 0.0, 1000.0);
        public static final DoubleSpec TENSION_BREAK_THRESHOLD = new DoubleSpec(9.0, 0.0, 1000.0);
        ...
        // Velocity
        public static final DoubleSpec MAX_PLAYER_VELOCITY_Y_UP = new DoubleSpec(2.5, 0.0, 100.0);
        public static final DoubleSpec MAX_PLAYER_VELOCITY_Y_DOWN = new DoubleSpec(-4.0, -100.0, 0.0);
        public static final DoubleSpec MAX_PLAYER_VELOCITY_XZ = new DoubleSpec(2.5, 0.0, 100.0);

        // Lead
        public static final DoubleSpec PLAYER_SPEED_LEAD_THRESHOLD = new DoubleSpec(0.1, 0.0, 10.0, "Minimum player speed before a lead offset is applied.");
        public static final DoubleSpec PLAYER_SPEED_LEAD_MULTIPLIER = new DoubleSpec(2.0, 0.0, 100.0, "Velocity multiplier for the predictive anchor offset.");
        public static final DoubleSpec PLAYER_SPEED_LEAD_Y_DOWN_CAP = new DoubleSpec(-0.5, -100.0, 0.0, "Maximum downward component of the lead offset (negative).");

        // Advanced
        public static final DoubleSpec STIFFNESS = new DoubleSpec(1000.0, 1.0, 100000.0);
        public static final DoubleSpec DAMPING = new DoubleSpec(125.0, 1.0, 100000.0);
        public static final DoubleSpec ANGULAR_DAMPING = new DoubleSpec(850.0, 1.0, 100000.0);
        public static final DoubleSpec CREATIVE_STRENGTH_MULTIPLIER = new DoubleSpec(10.0, 1.0, 1000.0, "Multiplies stiffness, damping and force in Creative Super Strength mode.");
        public static final DoubleSpec SPEED_STIFFNESS_MULTIPLIER_FACTOR = new DoubleSpec(15.0, 0.0, 1000.0, "Factor scaling spring stiffness with player speed.");
        public static final DoubleSpec MAX_SPEED_STIFFNESS_MULTIPLIER = new DoubleSpec(8.0, 1.0, 1000.0, "Cap on the speed-based stiffness multiplier.");
        ...
        public static final DoubleSpec STABLE_ANGULAR_FORCE_MASS_BASE = new DoubleSpec(10.0, 0.0, 10000.0, "Constant term: stableForce = maxForce * (base + mass * factor).");
        public static final DoubleSpec STABLE_ANGULAR_FORCE_MASS_FACTOR = new DoubleSpec(0.5, 0.0, 1000.0, "Mass coefficient in the stable angular force formula.");
        public static final DoubleSpec ROTATING_ANGULAR_STIFFNESS_BASE = new DoubleSpec(1.5, 0.0, 100.0, "Base angular stiffness multiplier while actively rotating.");
        public static final DoubleSpec ROTATING_ANGULAR_STIFFNESS_RANGE = new DoubleSpec(4.5, 0.0, 500.0, "Range component of the rotation stiffness multiplier.");
        public static final DoubleSpec SWAY_ANGULAR_STIFFNESS_BASE = new DoubleSpec(0.6, 0.0, 100.0, "Base angular stiffness multiplier when idle (sway mode).");
        public static final DoubleSpec SWAY_ANGULAR_STIFFNESS_RANGE = new DoubleSpec(5.4, 0.0, 500.0, "Range component of the idle sway stiffness multiplier.");

        // Client Input
        public static final DoubleSpec VERTICAL_ROTATION_SENSITIVITY = new DoubleSpec(0.5, 0.1, 10.0);
        public static final DoubleSpec HORIZONTAL_ROTATION_SENSITIVITY = new DoubleSpec(0.5, 0.1, 10.0);
        ...
        // Client Rendering
        public static final DoubleSpec ARM_TRANSITION_SPEED = new DoubleSpec(0.2, 0.01, 1.0, "Per-tick speed of the arm hide/show transition.");
        public static final DoubleSpec ARM_GRAB_LOWER_OFFSET = new DoubleSpec(1.5, 0.0, 20.0, "How far the vanilla arm is pushed down during partial transitions.");
        public static final DoubleSpec ASSEMBLY_SHAKE_MULTIPLIER = new DoubleSpec(0.04, 0.0, 10.0, "Camera shake scale while charging a block detach.");
        public static final DoubleSpec SHAKE_FREQUENCY_X = new DoubleSpec(3.0, 0.1, 100.0);
        public static final DoubleSpec SHAKE_FREQUENCY_Y = new DoubleSpec(4.0, 0.1, 100.0);
        public static final DoubleSpec SHAKE_FREQUENCY_Z = new DoubleSpec(5.0, 0.1, 100.0);
        ...
        public static final DoubleSpec GRAB_ARM_OFFSET_X = new DoubleSpec(0.18, -10.0, 10.0, "Horizontal positioning of the grab arms.");
        public static final DoubleSpec GRAB_ARM_OFFSET_Y = new DoubleSpec(-0.6, -10.0, 10.0, "Vertical positioning of the grab arms.");
        public static final DoubleSpec GRAB_ARM_OFFSET_Z = new DoubleSpec(-0.2, -10.0, 10.0, "Depth positioning of the grab arms.");

        // Client Mining
        public static final BooleanSpec PREVENT_ASSEMBLY_WHEN_MINING = new BooleanSpec(true);
        public static final DoubleSpec BAREHANDED_ASSEMBLY_MINING_THRESHOLD = new DoubleSpec(0.05, 0.0, 1.0, "Mining progress above which assembly is blocked.");
    }
    ...
    public static class Common {
        ...
        public double playerSpeedLeadThreshold    = Specs.PLAYER_SPEED_LEAD_THRESHOLD.def();
        public double playerSpeedLeadMultiplier   = Specs.PLAYER_SPEED_LEAD_MULTIPLIER.def();
        public double playerSpeedLeadYDownCap     = Specs.PLAYER_SPEED_LEAD_Y_DOWN_CAP.def();
